...
const fuse = new Fuse(
  [
    ...
    'client.containers.getRawEvents',
    'client.containers.getTransportEvents',
    'client.containers.list',
    'client.containers.retrieve',
    'client.containers.update',
    'client.shippingLines.list',
    'client.shippingLines.retrieve',
    'client.metroAreas.retrieve',
    'client.ports.retrieve',
    'client.vessels.retrieveByID',
    'client.vessels.retrieveByImo',
    'client.terminals.retrieve',
    'client.parties.create',
    'client.parties.list',
    'client.parties.retrieve',
