...
sidebarTitle: "Claude"
description: "Connect claude.ai, Claude Desktop, or Claude Code to the Terminal49 MCP server with OAuth — no API key required."
keywords:
...
Then, inside a Claude Code session, run `/mcp`, select **terminal49**, and choose **Authenticate**. Your browser opens the Terminal49 sign-in page; after you log in, the server shows as connected.
