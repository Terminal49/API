...
Then select and install **Terminal49**. Cursor prompts you to connect the MCP server (the same browser OAuth sign-in) when the plugin first needs it. See the [repository README](https://github.com/Terminal49/agent-plugins#readme) for details.
