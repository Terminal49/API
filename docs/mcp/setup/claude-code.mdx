...
<Note>
**No API key required.** The Terminal49 MCP server supports OAuth 2.1. When you authenticate, Claude Code opens a browser sign-in page. Log in with your Terminal49 credentials to finish.
</Note>
...
<Steps>
  ...
  <Step title="Sign in to Terminal49">
    Inside a Claude Code session, run `/mcp`, select **terminal49**, then select **Authenticate**. Your browser opens the Terminal49 sign-in page; after you log in and approve access, the server shows as connected.
  </Step>
