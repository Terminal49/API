...
For the full walkthrough (including local stdio dev, deployment, and SDK examples), see [MCP Server Quickstart](/docs/api-docs/in-depth-guides/mcp).
...
- Header: `Authorization: Token <T49_API_TOKEN>`
- `Bearer <T49_API_TOKEN>` is accepted for backward compatibility, but `Token` is the canonical scheme.
...
OAuth is not available for the hosted MCP server yet. Use a Terminal49 API token until OAuth support is published.
...
**REST equivalent**: [GET /containers](/docs/api-docs/api-reference/containers/list-containers) with filters
...
**REST equivalent**: [POST /tracking_requests](/docs/api-docs/api-reference/tracking-requests/create-a-tracking-request)
...
**REST equivalent**: [GET /containers/{id}](/docs/api-docs/api-reference/containers/get-a-container)
...
**REST equivalent**: [GET /containers/{id}/transport_events](/docs/api-docs/api-reference/containers/get-a-containers-transport-events)
...
**REST equivalent**: [GET /shipments/{id}](/docs/api-docs/api-reference/shipments/get-a-shipment)
...
**REST equivalent**: [GET /shipping_lines](/docs/api-docs/api-reference/shipping-lines/shipping-lines)
...
See [Entitlements and Paid Features](/docs/api-docs/useful-info/entitlements) for the related Routing Data entitlement.
</Warning>
...
**REST equivalent**: [GET /containers/{id}](/docs/api-docs/api-reference/containers/get-a-container) (route data is included with the container)
...
**REST equivalent**: [GET /shipments](/docs/api-docs/api-reference/shipments/list-shipments)
...
**REST equivalent**: [GET /containers](/docs/api-docs/api-reference/containers/list-containers)
...
**REST equivalent**: [GET /tracking_requests](/docs/api-docs/api-reference/tracking-requests/list-tracking-requests)
...
These Terminal49 API capabilities are available via the [SDK](/docs/api-docs/in-depth-guides/mcp#sdk-usage) but not yet exposed as MCP tools:

| API | Description | Workaround |
|-----|-------------|------------|
| `update_shipment` | Update shipment ref numbers/tags | Use [REST API](/docs/api-docs/api-reference/shipments/edit-a-shipment) |
| `stop_tracking` | Stop tracking a shipment | Use [REST API](/docs/api-docs/api-reference/shipments/stop-tracking-shipment) |
| `resume_tracking` | Resume tracking a shipment | Use [REST API](/docs/api-docs/api-reference/shipments/resume-tracking-shipment) |
| `raw_events` | Get raw EDI event data | Use [REST API](/docs/api-docs/api-reference/containers/get-a-containers-raw-events) |
| `refresh_container` | Force refresh container data | Use [REST API](/docs/api-docs/api-reference/containers/refresh-container) |
| Webhooks | Real-time event notifications | Configure via [dashboard](/docs/api-docs/in-depth-guides/webhooks) |
...
- [MCP Server Quickstart](/docs/api-docs/in-depth-guides/mcp) – Full setup, local dev, deployment
- [Rate Limiting](/docs/api-docs/in-depth-guides/rate-limiting) – Same limits apply to MCP
- [Test Numbers](/docs/api-docs/useful-info/test-numbers) – Containers for testing
- [Webhooks](/docs/api-docs/in-depth-guides/webhooks) – Real-time updates (use with MCP for best results)
