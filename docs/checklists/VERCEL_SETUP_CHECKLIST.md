...
- [ ] **Build command configured**
  ...
  # Should show: "cd packages/mcp && npm install && npm run build"
  ```

- [ ] **Output directory configured**
  ```bash
  cat vercel.json | grep outputDirectory
  # Should show: "packages/mcp/dist"
  ```
...
```json
{
  ...
  "outputDirectory": "packages/mcp/dist",
  "functions": {
    "api/mcp.ts": {
      "runtime": "nodejs20.x",
      "maxDuration": 30,
...
- **packages/mcp/TRANSPORT_SUPPORT.md** - HTTP vs SSE comparison
