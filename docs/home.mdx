      ...
      <div className="flex flex-col items-start justify-center w-full max-w-4xl text-left">
        ...
        <div className="flex flex-row gap-4 mt-5">
          <a
            ...
            className="px-5 flex items-center font-medium text-sm rounded-full py-2 shadow-sm text-white dark:text-gray-900 bg-primary-dark dark:bg-primary-light hover:opacity-[0.9] transition-opacity no-underline justify-center"
          >
            Get started
            <svg
