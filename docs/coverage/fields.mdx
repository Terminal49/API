...
description: "Reference for which shipment, container, and milestone fields the Terminal49 API returns, and whether each field is always present or source-dependent."
keywords:
  - "Terminal49 API"
  - "data availability"
  - "shipment fields"
