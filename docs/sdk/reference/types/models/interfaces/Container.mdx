...
description: "Container interface in the Terminal49 TypeScript SDK, the mapped response model with container number, status, ETA, route, demurrage, holds, and fees."
---
