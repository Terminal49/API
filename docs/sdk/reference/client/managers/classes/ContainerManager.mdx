...
| Parameter | Type |
| ------ | ------ |
| `filters` | \{ `carrier?`: `string`; `include?`: [`ContainerInclude`](/sdk/reference/types/options/type-aliases/ContainerInclude)[]; `port?`: `string`; `status?`: `string`; `updatedAfter?`: `string`; \} \| `undefined` |
