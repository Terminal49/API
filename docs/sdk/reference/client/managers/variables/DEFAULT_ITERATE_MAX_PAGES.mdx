...
description: "DEFAULT_ITERATE_MAX_PAGES constant in the Terminal49 TypeScript SDK, the default safety cap of 1000 pages applied to BaseManager createIterator pagination."
---
