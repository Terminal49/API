...
| Parameter | Type |
| ------ | ------ |
| `params` | \{ `refNumbers?`: `string`[]; `requestNumber`: `string`; `requestType`: [`TrackingRequestType`](/sdk/reference/client/type-aliases/TrackingRequestType); `scac?`: `string`; `shipmentTags?`: `string`[]; \} |
| `params.refNumbers?` | `string`[] |
| `params.requestNumber` | `string` |
| `params.requestType` | [`TrackingRequestType`](/sdk/reference/client/type-aliases/TrackingRequestType) |
| `params.scac?` | `string` |
...
| ------ | ------ |
| `number` | `string` |
| `options` | [`CreateTrackingRequestFromInferOptions`](/sdk/reference/client/interfaces/CreateTrackingRequestFromInferOptions) |
...
| `options?` | [`CallOptions`](/sdk/reference/types/options/interfaces/CallOptions) | `undefined` |
