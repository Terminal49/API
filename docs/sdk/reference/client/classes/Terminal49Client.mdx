...
| ------ | ------ |
| `id` | `string` |
| `include` | [`ContainerInclude`](/sdk/reference/types/options/type-aliases/ContainerInclude)[] |
...
| Parameter | Type |
| ------ | ------ |
| `filters` | \{ `carrier?`: `string`; `include?`: [`ContainerInclude`](/sdk/reference/types/options/type-aliases/ContainerInclude)[]; `port?`: `string`; `status?`: `string`; `updatedAfter?`: `string`; \} |
| `filters.carrier?` | `string` |
| `filters.include?` | [`ContainerInclude`](/sdk/reference/types/options/type-aliases/ContainerInclude)[] |
| `filters.port?` | `string` |
