---
title: "Terminal49 SDK Methods Reference"
sidebarTitle: "Methods Reference"
description: "Review every Terminal49 TypeScript SDK method organized by resource — shipments, containers, tracking requests, webhooks, and more — with usage examples."
keywords:
  - "Terminal49 SDK"
  - "TypeScript SDK"
  - "methods reference"
...
| `client.getDemurrage(containerId)` | Returns a subset of demurrage-related fields for a container. See [holds, fees, and release readiness](/docs/api-docs/in-depth-guides/holds-and-fees) for context. |
...
See [Filtering & Pagination](/docs/sdk/filtering-pagination) for details.
