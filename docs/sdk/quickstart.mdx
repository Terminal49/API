---
title: "Terminal49 SDK Quickstart"
sidebarTitle: "Quickstart"
description: "Install the Terminal49 TypeScript SDK, track a container, list shipments, and retrieve live tracking data in a few minutes with working examples."
keywords:
  - "Terminal49 SDK"
  - "TypeScript SDK"
  - "quickstart"
...
Make sure you have [installed the SDK](/docs/sdk/introduction) and set your `T49_API_TOKEN` environment variable.
...
- [Methods Reference](/docs/sdk/methods) — See all available operations
- [Filtering & Pagination](/docs/sdk/filtering-pagination) — Query large datasets efficiently
- [Webhooks](/docs/api-docs/in-depth-guides/webhooks) — Get notified when shipments update
