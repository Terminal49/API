...
| `fees_at_pod_terminal`            | Current fee amounts, in JSON format. See [hold and fee types](/api-docs/in-depth-guides/holds-and-fees).       | `text`      |
| `demurrage_at_pod_terminal`       | Current demurrage amount owed. See [fee types](/api-docs/in-depth-guides/holds-and-fees#fee-types-at-a-glance). | `text`      |
| `holds_at_pod_terminal`           | Current terminal hold statuses, in JSON format. See [hold types](/api-docs/in-depth-guides/holds-and-fees#hold-types-at-a-glance). | `text`      |
