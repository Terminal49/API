---
title: Containers
og:title: Rail Container Table Properties | Terminal49 Datasync
og:description: Get information on rail container table properties via Terminal49's Datasync API.
---
...
| `fees_at_pod_terminal`            | Current fee amounts at the POD terminal, in JSON format. See [hold and fee types](/api-docs/in-depth-guides/holds-and-fees). | `text`     |
| `demurrage_at_pod_terminal`       | Current demurrage amount owed at the POD terminal. See [fee types](/api-docs/in-depth-guides/holds-and-fees#fee-types-at-a-glance). | `text`     |
| `holds_at_pod_terminal`           | Current terminal hold statuses at the POD, in JSON format. See [hold types](/api-docs/in-depth-guides/holds-and-fees#hold-types-at-a-glance). | `text`     |
