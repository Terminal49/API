---
title: Shipments
og:title: Shipment Table Properties | Terminal49 Datasync
og:description: Retrieve shipment table properties with the Datasync feature from Terminal49 for detailed tracking.
---
