...
The [List containers](/api-docs/api-reference/containers/list-containers) endpoint now documents `filter[current_status]` so you can request only containers in a specific status:
