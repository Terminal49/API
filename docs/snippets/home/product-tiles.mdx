                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-[15px] text-black dark:text-white m-0 flex items-center gap-2">
                      {item.title}
                      {item.badge && (
                        <span className="text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">{item.badge}</span>
                      )}
                    </h3>
