...
description: "Migrate container tracking to Terminal49 from project44, FourKites, Vizion, ShipsGo, GoComet, Gnosis Freight, SeaRates, OpenTrack, or Beacon."
---
...
<Steps>
  <Step title="Self-serve an API key">
    Create an account at [app.terminal49.com](https://app.terminal49.com) and generate a key under [Developers → API Keys](https://app.terminal49.com/developers/api-keys). The free plan lets you create tracking requests through the API for up to 10 active containers. To read and export tracking data and use webhooks, open [Developers](https://app.terminal49.com/developers) and click **Start trial**. The trial lasts 7 days and keeps the same 10-container limit.
  </Step>
