...
description: "Map ShipsGo container tracking API fields, webhooks, and errors to Terminal49 equivalents. Covers carrier coverage, widget replacement, checklist."
---
