...
<Note>
  The free plan tracks up to 10 active containers and lets you create tracking requests through the API. To read and export tracking data and use webhooks, open [Developers](https://app.terminal49.com/developers) and click **Start trial**. The trial lasts 7 days and keeps the same 10-container limit.
</Note>
