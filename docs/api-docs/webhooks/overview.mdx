...
sequenceDiagram
    ...
    Your System->>Terminal49: Returns a success status
```
...
- **Database and TMS updates** — push every update into your database, ERP, or TMS as it happens. For managed table delivery into a data warehouse, database, or spreadsheet, see [DataSync](/datasync/home)
...
- Allowlist Terminal49 webhook IPs with the [List Webhook IPs](/api-docs/api-reference/webhooks/list-webhook-ips) endpoint.
...
See [Setting up webhooks](/api-docs/in-depth-guides/webhooks) for signature examples and [Webhook Best Practices](/api-docs/webhooks/best-practices) for retry handling.
...
<CardGroup cols={2}>
  ...
  <Card title="Payloads" icon="brackets-curly" href="/api-docs/webhooks/payloads">
