...
| `container.pickup_lfd_rail.changed` | The rail terminal's Last Free Day changed for an inland rail move |
...
For a deeper explanation of holds, fees, and the `available_for_pickup` field, see [Container Holds, Fees, and Release Readiness](/docs/api-docs/in-depth-guides/holds-and-fees).
...
- [Container Holds, Fees, and Release Readiness](/docs/api-docs/in-depth-guides/holds-and-fees) — full guide to hold and fee fields
- [Event catalog](/docs/api-docs/webhooks/event-catalog) — all available events
- [Payload examples](/docs/api-docs/useful-info/webhook-events-examples) — complete JSON payloads
