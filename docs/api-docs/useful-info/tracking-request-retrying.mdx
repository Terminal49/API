...
To check the status of your tracking request, make a [GET request](/docs/api-docs/api-reference/tracking-requests/get-a-single-tracking-request) using its `id` to see how many times it has retried and what the most recent failure reason was.