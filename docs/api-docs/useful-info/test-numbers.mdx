...
description: "Use Terminal49 test tracking numbers to simulate successful, failed, and edge-case tracking request outcomes when validating your sandbox integration."
keywords:
  - "Terminal49 API"
  - "integration guide"
...
You create shipments by making requests to the tracking request API. 
