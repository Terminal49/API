...
---
<Info>
For the shared webhook notification envelope and included-resource rules, see [Webhook Payloads](/docs/api-docs/webhooks/payloads).

Container payloads in these examples include `holds_at_pod_terminal`, `fees_at_pod_terminal`, and `available_for_pickup` fields. To understand the possible values and how to use them for pickup readiness, see [Container Holds, Fees, and Release Readiness](/docs/api-docs/in-depth-guides/holds-and-fees).
</Info>
