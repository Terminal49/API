...
<CodeGroup>
  <Code title="Polling Example" lang="javascript">
...
<CodeGroup>
  <Code title="Webhook Setup" lang="javascript">
  ...
  <Code title="Webhook Registration" lang="javascript">
...
<CodeGroup>
  <Code title="Hybrid Approach" lang="javascript">
