---
title: "Identify Your Carrier with Infer Tracking Number"
sidebarTitle: "Infer Tracking Number 🆕"
description: "Use the Terminal49 Infer Tracking Number endpoint to identify a carrier SCAC from a bill of lading or container number before you create a tracking request."
keywords:
  - "Terminal49 API"
...
<CardGroup cols={2}>
  <Card
    title="Infer Tracking Number API Reference"
    icon="code"
