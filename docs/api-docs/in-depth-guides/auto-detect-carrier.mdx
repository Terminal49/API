...
<Note>
  **Beta Feature** — This guide covers the [Infer Number
  API](/docs/api-docs/api-reference/tracking-requests/auto-detect-carrier), currently
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="circle-plus"
    href="/docs/api-docs/api-reference/tracking-requests/create-a-tracking-request"
  >
  ...
  <Card
    ...
    icon="ship"
    href="/docs/api-docs/useful-info/api-data-sources-availability"
  >
  ...
  <Card
    ...
    icon="arrows-spin"
    href="/docs/api-docs/in-depth-guides/tracking-request-lifecycle"
  >
