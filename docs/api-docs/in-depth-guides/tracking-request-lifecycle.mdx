...
<Tip>
  To reduce tracking failures, use [Infer Tracking
  Number](/api-docs/in-depth-guides/auto-detect-carrier) (Auto-Detect Carrier)
  to validate numbers and identify the correct SCAC before submitting.
</Tip>
