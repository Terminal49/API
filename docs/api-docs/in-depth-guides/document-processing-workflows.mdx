...
Before creating the document, complete the direct upload flow and get a `signed_id`: [`Direct Upload for Documents`](/docs/api-docs/in-depth-guides/direct-upload-documents).
...
- [`POST /documents`](/docs/api-docs/api-reference/documents/upload-a-document)
