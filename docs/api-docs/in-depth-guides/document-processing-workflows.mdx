...
`document_representation.created` example:
...
| Event | Meaning |
| --- | --- |
| `document_representation.created` | Extraction completed successfully |
| `document_representation.failed` | Extraction did not complete |
