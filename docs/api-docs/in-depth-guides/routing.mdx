...
<Note>
    ⚠️ **Premium Feature:** Routing Data (Container Route and Vessel Tracking APIs) is a premium feature available to paying customers. These APIs are subject to additional terms of usage and pricing. If you are interested in using these APIs, please contact <a href="mailto:sales@terminal49.com">sales@terminal49.com</a>.
</Note>
