...
Use the [Webhook Notifications API](/api-docs/api-reference/webhook-notifications/list-webhook-notifications) to review failed deliveries:
...
Use [Trigger a Webhook](/api-docs/api-reference/webhooks/trigger-a-webhook) to replay notifications after you fix the consumer.
