...
<Note>
Just want to get started fast? See the per-tool setup guides for [Claude](/mcp/setup/claude), [ChatGPT](/mcp/setup/chatgpt), [Cursor](/mcp/setup/cursor), [Microsoft Copilot](/mcp/setup/microsoft-copilot), and [VS Code](/mcp/setup/vs-code), or the [MCP Overview](/mcp/home) for a 5-minute setup.
</Note>
...
- [Claude](/mcp/setup/claude) – claude.ai, Claude Desktop, and Claude Code
...
- Setup guides: [Claude](/mcp/setup/claude), [ChatGPT](/mcp/setup/chatgpt), [Cursor](/mcp/setup/cursor), [Microsoft Copilot](/mcp/setup/microsoft-copilot), [VS Code](/mcp/setup/vs-code), [Other clients](/mcp/setup/other-clients)
