...
- **Endpoint (HTTP/streamable)**: `/api/mcp` {/* vale off */}
- **Auth**: `Authorization: Bearer <T49_API_TOKEN>` (no OAuth required) {/* vale off */}
- **SDK Package**: `@terminal49/sdk` (local workspace in this repo) {/* vale off */}
