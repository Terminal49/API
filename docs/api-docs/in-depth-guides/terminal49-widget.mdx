...
<AccordionGroup>
  ...
  <Accordion title="Is there a cost to embed the widget?">
    Yes. Widget access is priced separately from standard API access. Contact support@terminal49.com for widget pricing and to enable access. See [Entitlements and Paid Features](/api-docs/useful-info/entitlements) for access requirements.
  </Accordion>
</AccordionGroup>
...
![Terminal49 container tracking widget one-pager](/images/terminal49-container-tracking-widget.png)
