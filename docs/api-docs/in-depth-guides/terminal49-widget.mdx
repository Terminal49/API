...
First, you need a publishable widget API key. See [Entitlements and Paid Features](/docs/api-docs/useful-info/entitlements) for access requirements.
...
Widget access is priced separately from standard API access. See [Pricing](/docs/api-docs/useful-info/pricing) for current public pricing pointers.
