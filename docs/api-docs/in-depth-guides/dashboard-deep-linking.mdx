...
```
https://app.terminal49.com/shipments/deep-link?q={identifier}
```
...
| --- | --- | --- |
| Container number | `TCLU6718159` | `https://app.terminal49.com/shipments/deep-link?q=TCLU6718159` |
| Bill of lading number | `MEDUFR030802` | `https://app.terminal49.com/shipments/deep-link?q=MEDUFR030802` |
| Booking number | `BKG12345678` | `https://app.terminal49.com/shipments/deep-link?q=BKG12345678` |
| Reference number | `PO-2024-00123` | `https://app.terminal49.com/shipments/deep-link?q=PO-2024-00123` |
...
```
https://app.terminal49.com/shipments/deep-link?q={container_number}
```
...
```
=HYPERLINK("https://app.terminal49.com/shipments/deep-link?q=" & A2, "View in Terminal49")
```
...
View details: https://app.terminal49.com/shipments/deep-link?q=TCLU6718159
```
...
function buildDashboardLink(containerNumber) {
  return `https://app.terminal49.com/shipments/deep-link?q=${encodeURIComponent(containerNumber)}`;
}
```
...
SELECT
  container_number,
  CONCAT('https://app.terminal49.com/shipments/deep-link?q=', container_number) AS terminal49_link
FROM shipments
```
