...
<CardGroup cols={2}>
  <Card title="Tracking Widget" icon="browser" href="/docs/api-docs/in-depth-guides/terminal49-widget">
  ...
  <Card title="Tracking Request Lifecycle" icon="arrows-spin" href="/docs/api-docs/in-depth-guides/tracking-request-lifecycle">
