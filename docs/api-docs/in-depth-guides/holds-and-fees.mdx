...
<CardGroup cols={2}>
  <Card title="Container Statuses" icon="signal-bars" href="/docs/api-docs/in-depth-guides/container-statuses">
    How `available_for_pickup` and `current_status` are derived
  </Card>
  <Card title="Webhooks" icon="webhook" href="/docs/api-docs/in-depth-guides/webhooks">
    Subscribe to `container.updated` events
  </Card>
  <Card title="Event Timestamps" icon="clock" href="/docs/api-docs/in-depth-guides/event-timestamps">
    When terminal data was captured
  </Card>
  <Card title="Rail Integration" icon="train" href="/docs/api-docs/in-depth-guides/rail-integration-guide">
