...
description: "Use the Terminal49 Infer Tracking Number endpoint to predict the carrier SCAC and number type from a bill of lading, booking, or container number with confidence scores."
sidebarTitle: Infer Tracking Number 🆕
og:title: Infer Tracking Number | Terminal49 API Documentation
og:description: Use the Terminal49 Infer Tracking Number endpoint to predict the carrier SCAC code and tracking number type from a bill of lading, booking, or container number.
...
<Card
  title="Infer Tracking Number Guide"
  icon="book"
