...
description: "Assign a party to a shipment in the Terminal49 API as shipper, consignee, notify party, customs broker, customer, freight forwarder, or dray carrier."
