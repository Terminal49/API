...
To read tracking data (`GET /v2/shipments`, `GET /v2/containers`, `GET /v2/tracking_requests/{id}`, and other endpoints), open [Developers](https://app.terminal49.com/developers) and click **Start trial**. The free trial gives you full API access for 7 days with the same 10-active-container limit. For access after the trial, see [Pricing](/api-docs/useful-info/pricing).
