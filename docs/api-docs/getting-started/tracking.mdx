---
title: Complete Tracking Guide
description: Learn about all methods of tracking shipments in Terminal49, tracking request lifecycle, and available API endpoints.
...
Terminal49 offers multiple ways to start tracking your shipments:
...
<CardGroup cols={3}>
  ...
  <Card title="Dashboard Interface" icon="browser">
    Manually enter tracking numbers through Terminal49's web dashboard for immediate tracking.
  </Card>
...
1. Prepare a CSV file with columns for tracking numbers, carrier codes, and optional reference numbers
2. Email the CSV file to imports@terminal49.com
...
<Note>
  Contact your Terminal49 account manager for the exact CSV format requirements and processing schedule.
</Note>

## Trackable Reference Types
