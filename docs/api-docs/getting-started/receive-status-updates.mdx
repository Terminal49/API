...
Terminal49 posts status updates to a webhook that you register.
...
You can set up a new webhook by visiting https://app.terminal49.com/developers/webhooks and clicking the 'Create Webhook Endpoint' button.
...
The most common webhook notifications are status updates on tracking requests, like **tracking_request.succeeded** and updates on ETAs, shipment milestones, and terminal availability.
