...
```sh
npm install git+ssh://git@github.com:Terminal49/API.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Terminal49/API/issues) with questions, bugs, or suggestions.
